# Contributing to platform-dashboard
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/platform-dashboard.git
cd platform-dashboard

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/platform-dashboard.git
